...
const AddAssignmentDialog: React.FC<AddAssignmentProps> = ({ id }) => {
  ...
  async function addassignment() {
    try {
      const resp = await httpClient.post(`//${process.env.NEXT_PUBLIC_BACKEND_URL}/assignments`, {
        name: assignmentName,
      ...
      <Dialog>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Input valid information to add an assignment
            </DialogDescription>
          </DialogHeader>
