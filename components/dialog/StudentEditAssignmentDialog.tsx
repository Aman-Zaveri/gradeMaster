...
interface StudentEditAssignmentDialogProps {
  assignment: {
    id: string;
    name: string;
    start: string;
...
const StudentEditAssignmentDialog: React.FC<StudentEditAssignmentDialogProps> = ({
  assignment,
  studentId,
}) => {
  ...
  async function updateAssignment() {
    try {
      const resp = await httpClient.put(
        `//${process.env.NEXT_PUBLIC_BACKEND_URL}/students/${studentId}/assignments/${assignment.id}`,
        {
          name: assignmentName,
...
export default StudentEditAssignmentDialog;
